     ...
     <!--Slider End-->
					...
					<div class="tiles">
					 <div class="cube">
						...
						<div class="tile_back_face tile_01_backface">
						   <div class="imageonMob"><img src="<?=base_url?>assets/images/hov-img1.jpg" alt="hov-img"></div>
		...
		<section id="subsidiaries">
            <div class="container">
                ...
                <ul>
                    <li>
                        <a href="javascript:;"><img src="<?=base_url?>assets/images/astral-adh.png" alt="adhesive"></a>
                    </li>
                    <li>
                        <a href="javascript:;"><img src="<?=base_url?>assets/images/resinova.png" alt="resinova"></a>
                    </li>
                    <li>
                        <a href="javascript:;"><img src="<?=base_url?>assets/images/bond-it.png" alt="bond it"></a>
                    </li>
                    <li>
                        <a href="javascript:;"><img src="<?=base_url?>assets/images/rex.png" alt="rex"></a>
                    </li>
                </ul>
            </div>
        </section>
