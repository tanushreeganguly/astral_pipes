...
$res_arr	= $objTypes->fetchRow("SELECT * FROM tbl_event WHERE id = :id", $params);
?>

<div class="content-wrapper">
  <!-- Content Header (Page header) -->
  <section class="content-header">
    <h1> <?=$mode?> Event List <small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="list_event.php"><i class="fa fa-navicon"></i> Event List</a></li>
    </ol>
  </section>
  <!-- Main content -->
           ...
           <input type="hidden" name="pgNo" id="pgNo" value="<?=$_REQUEST['pgNo']?>"  />
			...
			<div class="form-group">
             ...
             <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Address..." name="address" id="address" rows="3" style="width:40%;"><?=($res_arr['address'])?></textarea>
              </div>
			  ...
			  <!--div class="form-group">
                ...
                <div class="input-group date" style="width:40%;">
                  ...
                  <input type="text" class="form-control pull-right" id="release_date" name="release_date" value="<?=stripslashes($res_arr['release_date'])?>"  placeholder="Release date" required>
                </div>
              </div-->
			   ...
			   <div class="form-group">
                ...
                <div class="input-group date" style="width:40%;">
                  ...
                  <input type="text" class="form-control pull-right" id="from_date" name="from_date" value="<?=stripslashes($res_arr['from_date'])?>"  placeholder="From date" required>
                </div>
              </div>
			   ...
			   <div class="form-group">
                ...
                <div class="input-group date" style="width:40%;">
                  ...
                  <input type="text" class="form-control pull-right" id="to_date" name="to_date" value="<?=stripslashes($res_arr['to_date'])?>"  placeholder="To date" required>
                </div>
              </div>
                ...
                <a href="#" id='existing_image'><img src="../uploads/event_images/<?=stripslashes($res_arr['thumbnail'])?>"  onerror="this.style.display='none'" height="80" width="100" onclick='window.open("../uploads/testimonial_images/<?=stripslashes($res_arr['thumbnail'])?>","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
				<?php } ?>
              </div>					
              <div class="form-group">
