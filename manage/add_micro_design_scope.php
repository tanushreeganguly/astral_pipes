...
if($id!=0){
	$res_arr	= $objTypes->fetchRow("SELECT * FROM tbl_micro_design_scope WHERE id = :id", $params);
}
?>
<div class="content-wrapper">
  <!-- Content Header (Page header) -->
  <section class="content-header">
    <h1> <?=$mode?> Designs scope <small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="list_micro_design_scope.php"><i class="fa  fa-navicon"></i> Designs scope List</a></li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary" >
          ...
          <form id="productForm" role="form" method="post" action="act_micro_design_scope.php" onsubmit="return validateForm();" enctype="multipart/form-data">
          <input type="hidden" name="id" id="id" value="<?=$res_arr['id']?>"  />
           <input type="hidden" name="pgNo" id="pgNo" value="<?=$_REQUEST['pgNo']?>"  />
            <div class="box-body">
              <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <input type="text" class="form-control " id="title2" name="title2" value="<?=stripslashes($res_arr['title2'])?>" placeholder="Title" style="width:40%;">
              </div>
			  <div class="form-group">
			...
			<div class="form-group">
                ...
                <input type="text" class="form-control " id="external_url" name="external_url" value="<?=stripslashes($res_arr['external_url'])?>" placeholder="External Url" style="width:40%;">
              </div>
			 <!--div class="form-group">
			 ...
			 <!--div class="form-group">
			  ...
			  <div class="form-group">
				<label for="exampleInputEmail1">  Image</label>
					...
					<a href="#" id='existing_image'><img src="../uploads/micro_design_scope/<?=stripslashes($res_arr['image'])?>"  onerror="this.style.display='none'" width="100" onclick='window.open("../uploads/micro_design_scope/<?=stripslashes($res_arr['image'])?>","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
						<?php } ?>
				</div>
              <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <a href="list_micro_design_scope.php?&pgNo=<?php echo intval(base64_decode($_REQUEST['pgNo'])); ?>" class="btn btn-danger" >Back</a>
            </div>
          </form>
        </div>
        <!-- /.box -->
...
jQuery(function(){
    jQuery('.img-wrap2 .close2').click(function() {
        ...
        if(confirm('Are you sure you want to delete selected images?')) {
           	window.location.href = '<?=base_url?>act_micro_design_scope.php?id='+id+'&param=rimg&prodid=<?php echo $id ?>&pgNo=<?=$_REQUEST['pgNo']?>';
