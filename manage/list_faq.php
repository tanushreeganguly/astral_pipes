...
$order		= 'title ASC';
if($title){
    $res_arr = $objTypes->select("tbl_faq", "*", "is_delete = :is_delete AND title LIKE :title", $where, "title ASC", $limit);
}
else{
    $res_arr = $objTypes->select("tbl_faq", "*", "is_delete = :is_delete", $where, "title ASC", $limit);
}
?>
