...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> List Gallery Images <small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="add_image.php"><i class="fa fa-plus-square"></i> Add Gallery Images</a></li>
    </ol>
  </section>
  <!-- Main content -->
            ...
            <table id="example2" class="table table-bordered table-hover" >
			  ...
			  ?>
                <tr>
                  ...
                  if($val['image'] != ""){
                      ?>
                      <img src="../uploads/astral_pipes_image/small/<?php echo $val['image']; ?>" width="100px"  />
                  ...
                  if($val['image1'] != ""){
                      ?>
                      <img src="../uploads/astral_pipes_image/large/<?php echo $val['image1']; ?>" width="100px"  />
