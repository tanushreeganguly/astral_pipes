...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> List investor<small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="add_investor.php"><i class="fa fa-plus-square"></i> Add investor</a></li>
    </ol>
  </section>
  <!-- Main content -->
            ...
            <table id="example2" class="table table-bordered table-hover" >
			  ...
			  ?>
                <tr>
				  ...
				  <td>
				  <?php if($val['broucher']!=''){ ?>
					  <a href="../uploads/investor_broucher/<?php echo $val['broucher']; ?>" id='existing_image' target="_blank"><img src="../images/pdf-icon.jpg"  /></a>
				  <?php }?>
				  </td>
				  <?php 
...
function Delete_CheckBox()
{
	...
	if(numberOfChecked>=1)
	{
		if(confirm("Are you sure  want to Delete Selected Record ?."))
		{
			...
			document.frmListing.action='act_investor.php?action=deleteall';
			document.frmListing.submit();
		}
	}
	else
...
function Active_CheckBox()
{
	...
	if(numberOfChecked>=1)
	{
		if(confirm("Are you sure  want to Activate Selected Record ?."))
		{
			...
			document.frmListing.action='act_investor.php';
			document.frmListing.submit();
		}
	}
	else
