...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> <?=$mode?> Astral Gallery <small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="list_image.php"><i class="fa  fa-navicon"></i> Astral Gallery List</a></li>
    </ol>
  </section>
  <!-- Main content -->
          ...
          <input type="hidden" name="id" id="id" value="<?=$TypeArray['id']?>"  />
           ...
           <input type="hidden" name="pgNo" id="pgNo" value="<?=$_REQUEST['pgNo']?>"  />
            <div class="box-body">
				  ...
				  <div class="form-group">
						<label for="exampleInputEmail1">Popup Images</label>
					...
					foreach($TypeArray_images as $mu_image){
                      ...
                      <div class="img-wrap2">
                        ...
                        <img src="../uploads/astral_pipes_image/small/<?=stripslashes($mu_image['image'])?>" data-id="<?php echo $mu_image['id'] ?>"  onerror="this.style.display='none'"  width="100" onclick='window.open("../uploads/astral_pipes_image/small/<?=stripslashes($mu_image['image'])?>","","width=600,height=600,scrollbars=Yes,resizable=yes")' />
					  </div>
                      <?php
                  }
                  ?>
