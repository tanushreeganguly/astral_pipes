...
$mode 		= ($id<>'0') ? 'Edit' : 'Add';
$params     = array(":id" => $id);
$res_arr	= $objTypes->fetchRow("SELECT * FROM tbl_micro_product WHERE id = :id", $params);
?>
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="list_micro_product.php"><i class="fa  fa-navicon"></i> product List</a></li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary" >
          ...
          <form role="form" method="post" action="act_micro_product.php" onsubmit="return validateForm();" enctype="multipart/form-data">
           ...
           <input type="hidden" name="pgNo" id="pgNo" value="<?=$_REQUEST['pgNo']?>"  />
            <div class="box-body">
			 <div class="form-group">
              ...
              <div class="form-group">Product name<?=MANDATORY?></label>
			   ...
			   <!--div class="form-group">
                ...
                <input type="text" class="form-control " id="label" name="label" value="<?=stripslashes($res_arr['label'])?>" placeholder="Title" style="width:40%;" >
              </div-->
              ...
              <div class="form-group">
				<label for="exampleInputEmail1"> Image</label>
					...
					<a href="#" id='existing_image'><img src="../uploads/micro_brand_product/<?=stripslashes($res_arr['image'])?>"  onerror="this.style.display='none'" width="100" onclick='window.open("../uploads/micro_brand_product/<?=stripslashes($res_arr['image'])?>","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
						<?php } ?>
				</div>
				<!--div class="form-group">
              ...
              <div class="form-group">
				<label for="exampleInputEmail1"> About Image</label>
					...
					<a href="#" id='existing_image'><img src="../uploads/micro_brand_product/<?=stripslashes($res_arr['about_image'])?>"  onerror="this.style.display='none'" width="100" onclick='window.open("../uploads/micro_brand_product/<?=stripslashes($res_arr['about_image'])?>","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
						<?php } ?>
				</div-->
            ...
            <div class="box-footer">
              ...
              <a href="list_micro_product.php?&pgNo=<?php echo intval(base64_decode($_REQUEST['pgNo'])); ?>" class="btn btn-danger" >Back</a>
            </div>
          </form>
        </div>
        <!-- /.box -->
