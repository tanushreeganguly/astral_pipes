$(document).ready(function() {
    ...
    function setBenchmarkEffects() {
        ...
        function showFirstCir(){
            ...
            TweenMax.to(ele, 1, {scale:1, ease:ease, onComplete:function(){
        ...
        function showDownCir(paramObj){
            ...
            var conDiv = $('<div class="conDiv"></div>');        
            var rotation = -30;  
            var x = -100;
            var y = 160;
            if(index%2==1){
            ...
            TweenMax.set(conDiv, {position:'absolute', 
                width:150, 
                rotation:rotation, 
                height:55, 
                left:0, 
            ...
            TweenMax.to(ele, speed, {scale:1, x:xyObj.x, y:xyObj.y, ease:ease, onComplete:function(){
                TweenMax.to(ele.find('.animationiconimg, h3, h4, p'), 0.6, {opacity:1, ease:Cubic.easeInOut});
